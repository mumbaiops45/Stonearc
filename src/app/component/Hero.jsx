        ...
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-10">
          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            <div className="relative mx-auto w-full max-w-lg">
              ...
              <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/95 p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="h-2.5 w-full overflow-hidden rounded-full bg-gray-100">
                      ...
                      <div className="h-full w-[98%] rounded-full bg-gradient-to-r from-blue-500 to-indigo-600" />
                  ...
                  <div>
                    ...
                    <div className="h-2.5 w-full overflow-hidden rounded-full bg-gray-100">
                      ...
                      <div className="h-full w-[99%] rounded-full bg-gradient-to-r from-green-500 to-emerald-600" />
                  ...
                  <div>
                    ...
                    <div className="h-2.5 w-full overflow-hidden rounded-full bg-gray-100">
                      ...
                      <div className="h-full w-[18%] rounded-full bg-gradient-to-r from-purple-500 to-fuchsia-600" />
                ...
                <div className="mt-10 grid grid-cols-3 gap-3 border-t border-gray-200 pt-6 sm:gap-5">

                  <div className="rounded-2xl bg-gradient-to-b from-gray-50 to-white px-3 py-5 text-center transition hover:-translate-y-1 hover:shadow-lg">
