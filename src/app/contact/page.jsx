                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 w-full pt-40 pb-28">
                    ...
                    >
                        <motion.div variants={fadeUp} className="flex items-center gap-4 mb-10">
                            <div className="w-8 h-[1px] bg-[#fd6402]/70" />
                            <span className="text-[#fd6402] text-[11px] tracking-[7px] uppercase font-semibold">Contact Us</span>
                            <div className="w-8 h-[1px] bg-[#fd6402]/70" />
                        </motion.div>
                        ...
                        >
                            Start Your Project
                            <span
                                className="block mt-3 text-transparent bg-clip-text bg-[#fd6402]" 
                            >
                                Conversation Today
                            </span>
                        </motion.h1>
                        ...
                        <motion.div variants={fadeUp} className="mt-12 flex items-center gap-5 flex-wrap">
                            <motion.a
                                ...
                                whileTap={{ scale: 0.97 }}
                                className="px-8 py-4 rounded-full font-semibold text-white text-sm bg-[#fd6402]"
                            >
                ...
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-blue-500/20 bg-blue-500/8 mb-10">
                            ...
                            <span className="text-[11px] tracking-[5px] uppercase text-[#fd6402] font-semibold">Our Approach</span>
                        </div>

                        <h2 className="text-4xl md:text-5xl font-bold leading-[1.12] tracking-[-0.03em]">
                            Start With a
                            <span className="block mt-2 text-transparent bg-clip-text bg-[#fd6402]">
                                Real Conversation
                            </span>
                        </h2>

                        <div className="w-12 h-[2px] bg-[#fd6402] rounded-full mt-8 mb-10" />
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-16">
                    ...
                    >
                        <div className="inline-flex items-center gap-4 mb-8">
                            <div className="w-10 h-[1px] bg-[#fd6402]/60" />
                            <span className="text-[#fd6402] text-[11px] tracking-[6px] uppercase font-semibold">Our Process</span>
                            <div className="w-10 h-[1px] bg-[#fd6402]/60" />
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold leading-[1.06] tracking-[-0.03em]">
                            What Happens When
                            <span className="block mt-3 text-transparent bg-clip-text bg-[#fd6402]"
                                >
                                You Contact Us
                            </span>
                        </h2>
                            ...
                            {(steps || [
                                ...
                                >
                                    ...
                                    <div className="relative flex-shrink-0 z-10">
                                        ...
                                        <div
                                            className="relative w-20 h-20 rounded-2xl flex items-center justify-center text-white font-bold text-lg border border-[#fd6402]/30 transition-all duration-500 group-hover:border-[#fd6402]/60 group-hover:scale-105"
                                    ...
                                    <div
                                        className="flex-1 rounded-3xl border border-white/8 p-8 md:p-10 transition-all duration-500 group-hover:border-[#fd6402]/25 overflow-hidden relative"
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-16">
                    ...
                    >
                        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-blue-500/20 bg-blue-500/8 mb-8">
                            <div className="w-1.5 h-1.5 rounded-full bg-[#fd6402] animate-pulse" />
                            <span className="text-[11px] tracking-[5px] uppercase text-[#fd6402] font-semibold">Get In Touch</span>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-[1.4fr_1fr] gap-8 items-start">
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="mt-6 w-full py-4 rounded-2xl font-semibold text-white text-[15px] transition-all duration-300 bg-[#fd6402]"
                        ...
                        >
                            ...
                            <div className="rounded-3xl border border-blue-500/15 p-7 relative overflow-hidden"
                                ...
                                <div className="text-[#fd6402]/80 text-[11px] tracking-[4px] uppercase font-semibold mb-3">Our Promise</div>
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-16">
                    ...
                    >
                        <div>
                            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-blue-500/20 bg-blue-500/8 mb-8">
                                <div className="w-1.5 h-1.5 rounded-full bg-[#fd6402] animate-pulse" />
                                <span className="text-[11px] tracking-[5px] uppercase text-[#fd6402] font-semibold">Why Us</span>
                            </div>
